...
pname = 'C:\Users\apcwy\Dropbox (The University of Manchester)\Physics PhD\TGS\Ben HT Data\HT_weld_2022-06-06\2022-06-06';
dir=cd(pname);
%%%%%%%%%%%%%%%%%%%
close all;

grat=6.4; % Initial grating spacing guess %Can be (nominally, MIT) 3.7, 5.8, 6.4, 7.0, 7.6, 9.4
overlay1=1;	% pulled from metadata in first file
overlay2=1;	% pulled from metadata in first file

posstr='Tungsten_Calibration-2022-06-06-06.40um-spot2-POS-1.txt';
negstr='Tungsten_Calibration-2022-06-06-06.40um-spot2-NEG-1.txt';
