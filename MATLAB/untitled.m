...
% directory location
basename = "/Users/aliciae/projects/shortlab/TGS-Processing-Scripts/MATLAB/pi3/2025-09-09";
pname = basename + "/data"; %ADJUST
pp_dir = basename + "/postprocessed";
mkdir(pp_dir);
