...
% for March 5 2026 Ni into Ni 525C

% directory location
base_dir="/Users/aliciae/MIT Dropbox/Alicia Elliott/Irradiations/2026/03/05-March-2026/pi3";
...
baseline_studyname="Baseline_Ni_into_Ni_6MeV_525C";

studyname = "He_then_Ni_into_Ni_6MeV_525C";
%studyname = "Ni_into_Ni_6MeV";
%studyname = baseline_studyname;
rundate = "2026-03-05";
grating_set = "03.40um";
%spotname = "He_implanted_baseline_preheat";
spotname = "Ni_irradiation";
%spotname = "spot00";
...
numberOfRuns=262; %ADJUST

start_num=1;
end_run=numberOfRuns;
% 283
POSbaselinestr = str_base + "POS-";
NEGbaselinestr = str_base + "NEG-";

% Calibrated grating spacings
grat = 3.4;%3.5124992;%3.5217; %in um %ADJUST
%3.5124992
%3.5124992 um
...
for j=start_num:numberOfRuns
    ...
    [freq,freq_err,speed,diff,diff_err,tau(:,3*(j)),tauErr, A, AErr, beta, betaErr, B, BErr, theta, thetaErr, C, CErr, file_date_time]=TGSPhaseAnalysis(pos_str,neg_str,grat,2,0,0,pos_str,NEGbaselinestr);
